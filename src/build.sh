...
$TARGET_BUSINESS_NAME is distributed with GPLv3 license. You can find the license on [GPL-v3](https://gitlab.aiursoft.com/FluxLinux/FluxLinux/-/blob/$TARGET_BUILD_BRANCH/LICENSE).
...
For detailed instructions, please visit [$TARGET_BUSINESS_NAME Document](https://docs.FluxLinux.com/Install/System-Requirements.html).
EOF
