...
# Before building FluxLinux, you should edit this file to customize the build process.
...
# See https://docs.FluxLinux.com/Install/Select-Best-Apt-Source.html
...
# Boolean indicator for whether to install FluxLinux-ibus-rime
