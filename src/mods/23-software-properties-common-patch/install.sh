...
sudo ln -sf /usr/share/python-apt/templates/ubuntu.info /usr/share/python-apt/templates/FluxLinux.info
sudo ln -sf /usr/share/distro-info/ubuntu.csv /usr/share/distro-info/FluxLinux.csv
