...
# ==============================================================================
# FluxLinux dconf System-Level Configuration
# ==============================================================================
...
print_ok "Configuring FluxLinux system-wide dconf defaults"
...
cp ./schemas/99-FluxLinux-defaults.gschema.override \
   /usr/share/glib-2.0/schemas/99-FluxLinux-defaults.gschema.override
...
mkdir -p /etc/dconf/db/FluxLinux.d
cp ./dconf-db/01-custom-keybindings.conf /etc/dconf/db/FluxLinux.d/
cp ./dconf-db/02-ptyxis-terminal.conf /etc/dconf/db/FluxLinux.d/
cp ./dconf-db/03-gnome-extensions.conf /etc/dconf/db/FluxLinux.d/
...
cat > /etc/dconf/db/FluxLinux.d/04-dynamic-configs.conf << EOF
# FluxLinux Dynamic Configuration
...
cp ./FluxLinux_text_smaller.png /usr/share/pixmaps/FluxLinux_text_smaller.png
judge "Copy GDM logo"
