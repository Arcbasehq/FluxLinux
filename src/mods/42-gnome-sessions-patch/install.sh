...
sed -i 's/Ubuntu/FluxLinux/g' /usr/share/gnome-session/sessions/ubuntu.session
...
if [ -f /usr/share/wayland-sessions/ubuntu.desktop ]; then
    mv /usr/share/wayland-sessions/ubuntu.desktop /usr/share/wayland-sessions/FluxLinux.desktop
    sed -i 's/Name=Ubuntu/Name=FluxLinux/g' /usr/share/wayland-sessions/FluxLinux.desktop
fi

if [ -f /usr/share/wayland-sessions/ubuntu-wayland.desktop ]; then
    mv /usr/share/wayland-sessions/ubuntu-wayland.desktop /usr/share/wayland-sessions/FluxLinux-wayland.desktop
    sed -i 's/Name=Ubuntu/Name=FluxLinux/g' /usr/share/wayland-sessions/FluxLinux-wayland.desktop
fi
