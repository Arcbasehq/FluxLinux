...
#=================================================
#    FluxLinux Auto-Repair Tool (do-FluxLinux-autorepair.sh)
#=================================================
...
# --- Global Variables ---
ISO_MNT_POINT="/mnt/FluxLinux_iso_repair"
DOWNLOAD_DIR="$HOME/Downloads/FluxLinux_repair_temp"
# FILE_PREFIX will be set after system detection (e.g., "FluxLinux-1.4.1")
FILE_PREFIX=""
...
FILE_PREFIX="FluxLinux-$SYS_VERSION"
...
# --- 2. Download Logic ---
CURRENT_LANG=${LANG%%.*}
BASE_URL="https://download.FluxLinux.com/$SYS_BASE_VERSION/$SYS_VERSION"
FILE_NAME_BASE="${FILE_PREFIX}-${CURRENT_LANG}" # e.g., FluxLinux-1.4.1-zh_CN
...
print_ok "Downloading FluxLinux $SYS_VERSION torrent and checksum..."
